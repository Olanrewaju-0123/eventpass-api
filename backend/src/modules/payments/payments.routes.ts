...
router.get(
  ...
  PaymentsController.getPaymentByReference
);
...
router.post(
  "/initialize",
  PaymentsController.initializePaymentValidation,
...
router.post(
  ...
  PaymentsController.initializeEventCreationPaymentValidation,
  PaymentsController.initializeEventCreationPayment
);
router.post("/process-mock-payment", PaymentsController.processMockPayment);
...
router.get(
  "/admin/statistics",
  requireAdmin,
  PaymentsController.getAllPaymentStatistics
);
router.post(
