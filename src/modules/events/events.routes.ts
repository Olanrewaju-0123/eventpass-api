...
router.post("/", requireOrganizer, EventsController.createEventValidation, EventsController.createEvent)
router.get("/my/events", requireOrganizer, EventsController.getMyEvents)
router.put("/:eventId", requireOrganizer, EventsController.updateEventValidation, EventsController.updateEvent)
router.delete("/:eventId", requireOrganizer, EventsController.deleteEvent)
router.get("/:eventId/statistics", requireOrganizer, EventsController.getEventStatistics)
